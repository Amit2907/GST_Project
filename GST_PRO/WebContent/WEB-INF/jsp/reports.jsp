...
<div class="inner-block">
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">All Reports</a></li>
    <li><a data-toggle="tab" href="#menu1">My Custom Reports</a></li>
    <li><a data-toggle="tab" href="#menu2">Sales Reports</a></li>
    <li><a data-toggle="tab" href="#menu3">GSTR Reports</a></li>
  </ul>
