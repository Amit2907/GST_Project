      ...
      <div class="container" style="margin-top:50px;">
        <form class="form-horizontal" method="post" action="">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-2">
		<div class="input-group">
			    <input id="partyid" name="partyname" placeholder=""  required="" type="text" class="t1">
            </div></div>
		...
		<div class="input-group">
               ...
               <textarea rows="3" cols="30" id="addrid" name="addrsname" placeholder=""  required="" type="text" class="t1">
            </textarea>
            </div>
		</div>
            ...
            <div class="col-md-2">
		<div class="input-group">
			    <input id="gstnoid" name="gstno" placeholder="GST NO"  required="" type="text" class="t1">
            </div></div>
          ...
          <div class="col-md-11 chit-chat-layer1-left">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                  <center>Party Customer Details</center>
                            </div><br>
