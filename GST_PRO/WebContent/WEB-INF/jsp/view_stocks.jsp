...
<div class="inner-block">
    <div class="blank">
    	...
    	<div class="blankpage-main">
            ...
            <label class="col-md-2 control-label" >Search Item By Name</label>
            <div class="col-md-2">
		          <div class="input-group" >
                     
			           <input id="searchitem" name="serachitem" placeholder="" required="" class="col-md-3" type="text" style="width: 178px; height: 35px;"><span class="input-group-addon">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-2">
		<div class="input-group">
			         <button id="search" name="search" class="btn btn-large btn-primary"> Search</button>
            </div>
		</div>
